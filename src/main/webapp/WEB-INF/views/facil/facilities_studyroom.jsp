...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1>
			스터디룸 예약 <small>예약 페이지</small>
		</h1>
		<ol class="breadcrumb">
			<!-- 페이지 기록 : 메인에서 부터 현재 페이지 까지의 경로 나열 -->
			<li><a href="#"><i class="fa fa-dashboard"></i> 메인</a></li>
			<li class="active">스터디룸 예약</li>
		</ol>
	</section>
	<!------------------------------------ 메인페이지 바디 [작업 내용] ------------------------------------------------------------>
						...
						<div class="box-body">
							...
							<div class="row">
								...
								<div class="form-group col-md-4">
									<label>시설명</label> <select class="form-control" name="sr_type"
										id="sr_type" onchange="selectfacil()">
								...
								<!-- 호수(두번째 카테고리) 선택 -->
								<div class="form-group col-md-4">
									<label>호수</label> <select class="form-control" id="sr_name"
										name="sr_name" onchange="select02()">
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group" id="sr_content" name="sr_content">
										<label>시설정보</label>
								...
								<div class="col-md-4">
									<label>대여 포인트</label> <input id="sr_point" type="text"
...
<script type="text/javascript">
	...
	//시설 선택을 셀렉트 생성. sr_type을 바탕으로 sr_name의 list를 출력한다.
	function selectfacil() {
		...
		$.getJSON("/facil/FacilSrNameAjax", {
			...
			$("#sr_name").append("<option>호수를 입력하세요.</option>");
			$(data).each(
	...
	// selectfacil()을 바탕으로 sr_content와 포인트, 시설번호를 불러온다.
	function select02() {
